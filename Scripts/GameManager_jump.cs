...
public class GameManager_jump : MonoBehaviour
{
    public static GameManager_jump Instance { get; set; }

    public UIManager_jump uIManager;
    public ScoreManager_jump scoreManager;
    ...
    void Update()
    {
        if (uIManager.gameState == GameState_jump.PLAYING)
        {
    ...
    {
        /*if (uIManager.gameState == GameState_jump.PAUSED)
            Time.timeScale = 1;
    ...
    public void GameOver()
    {
        if (uIManager.gameState == GameState_jump.PLAYING)
        {
            AudioManager_jump.Instance.PlayEffects(AudioManager_jump.Instance.gameOver);
